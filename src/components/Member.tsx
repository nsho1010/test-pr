...
const members = [
  {
    name: "山田太郎",
    role: "共同創設者, CEO",
    description: "革新的なアイデアで会社を牽引し、事業戦略の策定と実行に尽力。10年以上のIT業界経験を活かし、チームをリードしています。",
  ...
  },
  {
    name: "鈴木花子",
    role: "共同創設者, CTO",
    description: "優れた技術力でプロダクト開発を指揮。最新のテクノロジーを積極的に取り入れ、高品質なサービスの提供に注力しています。",
  ...
  },
  {
    name: "佐藤次郎",
    role: "製品部門責任者",
    description: "ユーザー目線に立った製品設計と開発を推進。お客様のニーズを的確に捉え、使いやすく価値あるプロダクトの創出に努めています。",
  ...
  },
  {
    name: "田中美咲",
    role: "マーケティング部門責任者",
    description: "市場調査と分析を基に、効果的なマーケティング戦略を立案・実行。ブランド認知度の向上と顧客獲得に貢献しています。",
    ...
    <section className="">
      <div className="flex flex-col items-center justify-center gap-16">
        <div className="space-y-3 text-center">
          <h2 className="text-3xl font-bold tracking-tighter underline decoration-primary decoration-1 underline-offset-8">チーム紹介</h2>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {members.map((member) => (
            <div key={member.name} className="flex flex-col items-center justify-center space-y-4">
              <Image alt={member.name} className="aspect-square w-32 rounded-full object-cover" src={member.image} width={100} height={100}/>
